...
model_filename = os.path.join(os.path.dirname(__file__), 'action_recognition_model.pkl')
mlb_filename = os.path.join(os.path.dirname(__file__), 'multilabel_binarizer.pkl')
